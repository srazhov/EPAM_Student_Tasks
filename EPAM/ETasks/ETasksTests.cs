...
namespace EPAM.Tests
{
    ...
    public class ETasksTests
    {
        ...
        {
            return ETasks.GetMaxElement(sourceArray);
        }
        ...
        {
            return ETasks.FindMagicalIndex(sourceArray);
        }
        ...
        {
            return ETasks.MergeStrings(firstStr, secondStr);
        }
        ...
        {
            return ETasks.FilterDigit(sourceArray, digit);
        }
